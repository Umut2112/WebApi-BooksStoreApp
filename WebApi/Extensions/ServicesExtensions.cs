        ...
        public static void ConfigureSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(s =>
            {
                s.SwaggerDoc("v1", 
                    new OpenApiInfo 
                    { 
                        Title = "Ali Umut Çiğdem", 
                        Version = "v1",
                        Description = "Ali Umut Çiğdem  ASP.NET Core Web API",
                        TermsOfService = new Uri("https://www.btkakademi.gov.tr/"),
                        Contact = new OpenApiContact
                        {
                            Name = "Ali Umut Çiğdem",
                            Email = "aliumut_21@outlook.com"
                        }
                    });
                
                s.SwaggerDoc("v2", new OpenApiInfo { Title = "Ali Umut Çiğdem", Version = "v2" });
